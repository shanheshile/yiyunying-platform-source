...
$required = @(
    ...
    'tools\prepare-offline-stt-runtime.py',
    'tools\install-production-stt-runtime.py',
    'tools\install-production-stt-runtime.ps1',
    'tools\stt\transcribe.py',
    'tools\stt\offline\artifacts.json',
    'tools\stt\offline\requirements-linux-x86_64-cp311.lock',
    'tools\stt\offline\model-manifest.json',
    'tools\stt\offline\builder-tools.json',
    'tools\stt\offline\license-evidence.json',
    'tools\stt\offline\remote-install.py',
    'docs\PRODUCTION_STT_RUNTIME.md',
    'tools\tests\test_prepare_offline_stt_runtime.py',
    'tools\tests\test_install_production_stt_runtime.py',
    'tools\tests\test_stt_runtime_selection.py',
    'tools\publish-android-ssh.py',
    'tools\verify-production-release-ssh.py',
    'tools\release_device_gate.py',
    ...
    'tools\tests\test_release_device_gate.py',
    '..\android\tools\verify-release-device-gate.ps1',
    '..\android\tools\new-release-risk-waiver.ps1',
    '..\docs\RELEASE_DEVICE_GATE.md',
