...
当前源码与本地发布候选：`2.7.14 (59)`；线上生产仍为 `2.7.13 (58)`。`2.7.14` 四端 Debug APK 已完成本地构建和校验，但尚未部署、未执行 2026-08-11 数据库迁移、未建立最终提交/标签，也未完成 E 盘最终归档。
...
- [2.7.14 本地发布候选说明：治理、媒体与可恢复更新](docs/releases/2.7.14.md)
